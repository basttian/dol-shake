...
/**
 * \file    test/phpunit/ShakeFunctionalTest.php
 * \ingroup shake
 ...
 * @package Testshake
 */
class ShakeFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/shake/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('shake/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/shake/admin/about.php');
		$this->authenticate();
		return $this->assertContains('shake/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('shakewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modShake_ShakeTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modShake_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
